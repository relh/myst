...
echo "Step 1: Installing PyTorch with latest CUDA support (see https://pytorch.org/get-started/locally/ for details)..."
uv pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu128

echo "Step 2: Installing core dependencies from pyproject.toml/requirements.txt..."
uv sync
